    ...
    return (
      <div className="popup">
        ...
        <div className="popup-content">
          ...
          <a href="#about-us" onClick={(e) => handleNavigation(e, "about-us")}>
            About Us
          </a>
          <a
            href="#our-pillars"
            onClick={(e) => handleNavigation(e, "our-pillars")}
          >
            Our Pillars
          </a>
          <a href="#mission" onClick={(e) => handleNavigation(e, "mission")}>
            Mission
          </a>
      ...
      <>
        <div className="main-container">
          ...
          <div className="download-app" id="about-us">
            <div className="heading">
              ...
              <span className="at-inventcare-we-specialize">
                At InventCare, we specialize in designing products that make
                ...
                always on you. We are inventors, creators, and dreamers united
                by a singular goal to bring holistic solutions to everyday
                challenges.
              </span>
            </div>
            <div className="group-3" />
          </div>
          <div className="heading-4" id="our-pillars">
          ...
          <div className="blog-card-mobile">
            ...
            <div className="div-7">
              <span className="simplifying-tasks-amplifying-impact">
                Simplifying tasks and amplifying impact through intelligent
                tools streamlines processes, boosts efficiency, and reduces
                errors. By automating routine tasks, we free up time for more
                valuable work, leading to greater productivity and impactful
                results.
              </span>
            </div>
          </div>
          ...
          <div className="blog-card-mobile-d">
            ...
            <div className="div-11">
              <span className="encouraging-self-expression">
                ...
                inspire creativity and innovation. Our designs empower
                individuals of all ages to explore their unique talents. From
                children to adults, we provide tools that help bring imagination
                and dreams to life.
              </span>
            </div>
          </div>
          <div className="blog-card-mobile-12">
            ...
            <div className="div-15">
              <span className="well-being-safety-solutions">
                ...
                families, offering protection in digital spaces. Every solution
                is designed to ensure security and enhance confidence.
              </span>
            </div>
          </div>
          ...
          <span className="transforming-learning">
            Transforming learning into a fun, rewarding experience while
            ensuring a child's well-being in a safe, positive environment.
          </span>
          <div className="div-2d">
            ...
            <span className="safe-fun-space">
              A safe, fun space where kids learn, grow, and flourish with
              engaging rewards and positive guidance.
            </span>
          </div>
          ...
          <div className="div-35">
            ...
            <span className="easy-to-use-features">
              ...
              child's online activities and experiences.
            </span>
          </div>
          <span className="champsverse-iot">Champsverse (iOT)</span>
          <span className="revolutionizing-childrens-play">
            Revolutionizing children's play with innovative, interactive toys
            that enhance focus and reduce online time.
          </span>
          ...
          <div className="div-40">
            ...
            <span className="well-being-security">
              Prioritizing the well-being and security of every individuals in
              all environments.
            </span>
          </div>
          ...
          <div className="footer-mobile">
            <div className="group-5a">
              ...
              <div className="flex-row-cf">
                ...
                <a href="#products" className="products-5e">
                  Products
                </a>
            ...
            <div className="flex-row-da">
              ...
              <div className="group-23">
                ...
                <span className="secure-loved-ones">
                  Keeping you and your loved ones secure, both online and
                  offline.
                </span>
              </div>
            </div>
