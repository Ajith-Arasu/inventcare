      ...
      <div className="flex-row-f-44">
        ...
        <div className="ios-47">
          ...
          <div className="iphones-48">
            ...
            <div className="buttons-4a">
              <div className="flex-column-e">
                <div className="silence-button-4b" />
                <div className="wrapper-11" />
                <div className="wrapper-12" />
              </div>
              <div className="power-button-4c" />
            </div>
          </div>
        </div>
        <div className="div-4d">
          <div className="div-4e">
        ...
        <div className="div-51">
          ...
          <span className="boosting-abilities">
...
export default ProductChampsVersIOT;
