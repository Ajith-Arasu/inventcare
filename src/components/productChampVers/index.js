    ...
    <>
      ...
      <div className="flex-row-dfb">
        ...
        <div className="div-3d">
          ...
          <span className="creativity-3f">creativity</span>
...
export default ProductChampsVers;
